...
- 마크다운 구조 최소 1회 이상 사용(예: `##` + bullet list)
- 마지막: `## 오늘의 한 줄` + 1문장
...
주요 모델 정책:
- 일기 작성 모델: `ollama/qwen3:14b`
- 코딩/설계 작업은 필요 시 별도 모델(Codex 등)로 진행 가능
...
- 원격 저장소: `origin = https://github.com/iamdrunkendog/gaemilog.git`
- 브랜치: `master`
